...
/**
  ...
  Run with: g++ -std=c++11 -lcpprest -lcrypto -lssl pa_get_order.cpp -o pa_get_order && ./pa_get_order
*/
...
class TestClass {
    ...
    private:
        const utility::string_t merchant_id = U("123");
        const utility::string_t secret_word = U("xxx");
